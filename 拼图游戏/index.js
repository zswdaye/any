let time = 0  //保存定时时间
let pause = true //设置是否暂停标志，true表示暂停
let set_timer //设置定时函数 
let d = new Array(10); //保存数字div的编号

//设置数字div可以去的位置，比如第一块可以去2,4号位置
//为了逻辑更简单，第一个元素不用，从下标1开始使用
...
//保存数字div的可移动位置编号，
//第一个值表示left，第二个值表示top，比如第一块的位置为let:0px,top:0px
